...
public class modBlocks {
    ...
    public static final RegistryObject<Block> DIAMOND_TROPHY = registerBlock("diamond_trophy", () -> new recyclerBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.DIAMOND).requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL)));
