...
public class modEnchantments {
    ...
    public static RegistryObject<Enchantment> SPELL_REMAINING = ENCHANTMENTS.register("spell_remaining", () -> new remainingSpellEnchantment(Enchantment.Rarity.VERY_RARE, RETURNING_COMPATIBLE, EquipmentSlotType.values()));
